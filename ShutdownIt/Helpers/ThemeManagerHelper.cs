...
namespace ShutdownIt.Helpers
{
    public static class ThemeManagerHelper
    {
        /// <summary>
        /// Create a MahApp Style by the given color
        /// </summary>
        /// <param name="color">Color</param>
        /// <param name="rawColor">Should we use the raw color or some accents ?</param>
        /// <param name="changeImmediately">Should the theme be applied immediately</param>
        public static void CreateAppStyleBy(Color color, bool rawColor = false, bool changeImmediately = false)
        {
            ...
            else
            {
                ...
                resourceDictionary.Add("AccentColor2", color);
                resourceDictionary.Add("AccentColor3", color);
                resourceDictionary.Add("AccentColor4", color);
            }
